...
puts "Seeding a band"
jazz_band = Band.find_or_initialize_by(band_name: 'Level 42')
jazz_band.save!
...
if venue.nil?
  ...
  review.save!
  review = Review.new(stars: 5, content: "They're a really awesome person. Really talented.", from_id: 5, to_id: 1, badges: "Great musician")
  review.save!
  ...
  review.save!
  review = Review.new(stars: 4, content: "They really know how to follow an intense tempo!", from_id: 10, to_id: 10, badges: "They're so funky!")
  review.save!
  ...
  review.save!
  review = Review.new(stars: 3, content: "Amazing musician.", from_id: 9, to_id: 3, badges: "Rock on!")
  review.save!
  review = Review.new(stars: 5, content: "Super talented and original.", from_id: 10, to_id: 1, badges: "Legend")
  review.save!
  review = Review.new(stars: 4, content: "They're a really cool person.", from_id: 8, to_id: 12, badges: "Total G")
  review.save!
  review = Review.new(stars: 3, content: "Incredible on stage", from_id: 11, to_id: 12, badges: "Live music is their passion")
  review.save!
